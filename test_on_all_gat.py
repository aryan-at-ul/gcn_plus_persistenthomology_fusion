...
class GraphClassificationModel(nn.Module):
    def __init__(self, in_channels, hidden_channels, num_classes, num_classes_dynamic, k, heads=1):
        ...
        # Define GAT layers
        self.gat1 = GATConv(325, 128, heads=heads)
        self.gat2 = GATConv(128 * heads, 128, heads=heads) # Adjust the in_channels according to the number of heads

        self.classifier = nn.Linear(128 * heads, n_classes)
...
model = GraphClassificationModel(5, 32, num_classes, num_classes_dynamic, k=8)
